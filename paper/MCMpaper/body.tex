...
decelerating and driver reaction distances. The sum, 
together with the minimum safe distance, is then the 
decelerating distance of the leading vehicle. This 
relation infers equation \ref{eq: Safe Distance 1 - 1}. 
The driver's reaction time is the gap between deceleration 
...
\begin{eqnarray}
& \frac{v_1^2 - v_0 ^ 2}{2a_1} + v_1 t_r - L = \frac{v_2 ^ 2 
- v_0 ^ 2}{2a_2} &\label{eq: Safe Distance 1 - 1}\\
